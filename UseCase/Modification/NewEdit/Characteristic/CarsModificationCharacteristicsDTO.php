...
final class CarsModificationCharacteristicsDTO implements CarsModificationCharacteristicsInterface
{
	...
	/** Шаси */
	#[Assert\Valid]
	private Chassis\CarsModificationChassisDTO $chassi;
	...
	public function __construct(){
		...
		//$this->chassi = new Chassis\CarsModificationChassisDTO();
	}
	...
	/** Шаси */
	public function getChassi() : Chassis\CarsModificationChassisDTO
	{
		return $this->chassi;
	}

	public function setChassi(Chassis\CarsModificationChassisDTO $chassi) : void
	{
		$this->chassi = $chassi;
	}
