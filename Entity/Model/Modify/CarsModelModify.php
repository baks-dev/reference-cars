...
/* Модификаторы событий CarsModelModify */

#[ORM\Entity]
#[ORM\Table(name: 'cars_model_modify')]
#[ORM\Index(columns: ['action'])]
class CarsModelModify extends EntityEvent
{
	public const TABLE = 'cars_model_modify';
	
	/** ID события */
	#[ORM\Id]
	#[ORM\OneToOne(inversedBy: 'modify', targetEntity: CarsModelEvent::class)]
	...
	public function getDto($dto): mixed
	{
		...
		if($dto instanceof CarsModelModifyInterface)
		{
	...
	{
		if($dto instanceof CarsModelModifyInterface || $dto instanceof self)
		{
