...
/* Модификаторы событий CarModificationModify */

#[ORM\Entity]
#[ORM\Table(name: 'cars_modification_modify')]
#[ORM\Index(columns: ['action'])]
class CarsModificationModify extends EntityEvent
{
    public const TABLE = 'cars_modification_modify';

    /** ID события */
    #[ORM\Id]
    #[ORM\OneToOne(inversedBy: 'modify', targetEntity: CarsModificationEvent::class)]
    ...
    public function getDto($dto): mixed
    {
        ...
        if($dto instanceof CarModificationModifyInterface)
        {
    ...
    {
        if($dto instanceof CarModificationModifyInterface || $dto instanceof self)
        {
