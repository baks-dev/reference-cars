...
final class CarsModelEventUid //implements ValueResolverInterface
{
	public const TYPE = 'cars_model_event';
	...
	public function resolve(Request $request, ArgumentMetadata $argument) : iterable
	{
		...
		$value = $request->attributes->get($argument->getName()) ?: $request->attributes->get('id') ?: $request->get(
			'id'
		);
