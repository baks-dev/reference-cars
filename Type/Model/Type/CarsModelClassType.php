...
final class CarsModelClassType extends StringType
{
    ...
    {
        return $value instanceof CarsModelClassEnum ? $value->value : (CarsModelClassEnum::from($value))->value;
    }
    
    public function convertToPHPValue($value, AbstractPlatform $platform) : mixed
    {
        return $value ? CarsModelClassEnum::from($value) : null;
    }
    
    public function getName() : string
    {
        return CarsModelClassEnum::TYPE;
    }
